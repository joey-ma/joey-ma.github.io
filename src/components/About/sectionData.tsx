...
export const sectionThree = [
  ...
  { title: 'On the same page', description: 'Understand clients needs and requirements, and the technical opportunities and challenges that exist within their categories.'},
